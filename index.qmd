...
repo-actions: false
description: |
  ConectaStat - Ciência, Estatística e Sociedade.
image: /images/capa-social.png
listing:
  # "Em Destaque" reúne, num rotator só, as notícias, os cursos/eventos e os
  # encontros com a comunidade (extensão): são pastas de posts diferentes, mas
  # para quem chega na home é tudo "o que está acontecendo agora", da data mais
  # recente à mais antiga. Um encontro entra aqui pelas mesmas regras de uma
  # notícia - basta ter title, description e date.
  - id: destaques
    contents:
      - /noticias/posts
      - /eventos/posts
      - /O_que_fazemos/extensao/acoes/posts
    sort: "date desc"
...
<div class="hero-banner">
  <div class="content-container">
    ...
    <!-- O disclaimer do projeto vive só no rodapé (ver _quarto.yml): repetido
         aqui no topo, roubava a entrada da home. -->
  </div>
</div>
```
...
<!-- ============================================================= -->
<!--  EM DESTAQUE - notícias e cursos/eventos no mesmo rotator     -->
<!-- ============================================================= -->
::: {.content-container}
::: {.listing-block}
