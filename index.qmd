...
listing:
  # "Em Destaque" reúne, num rotator só, as notícias e os cursos/eventos: são
  # duas pastas de posts diferentes, mas para quem chega na home é tudo "o que
  # está acontecendo agora", da data mais recente à mais antiga.
  - id: destaques
    contents:
      - /noticias/posts
      - /eventos/posts
